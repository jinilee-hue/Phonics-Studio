...
export function ReviewPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <h2 className="mb-1 text-[22px] font-bold text-brand-800">검수 대기 ({queue.length})</h2>
        ...
        <div className="sticky top-14 z-10 mb-3 flex flex-wrap items-center gap-2 rounded-xl bg-brand-700 px-4 py-2 text-sm text-white shadow">
          ...
          <span className="ml-auto flex flex-wrap gap-2 [&>button]:shrink-0 [&>button]:whitespace-nowrap">
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg bg-white px-3 py-1.5 text-xs font-bold text-brand-700 hover:bg-brand-50 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg bg-red-500 px-3 py-1.5 text-xs font-bold hover:bg-red-600"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5" aria-hidden="true">
            ...
            <button onClick={clearSelection} className="inline-flex items-center gap-1 rounded-lg border border-white/40 px-3 py-1.5 text-xs hover:bg-white/10">
        ...
        {queue.map((c) => (
          <div key={c.id} className="rounded-2xl bg-white p-4 shadow-card">
            <div className="flex flex-wrap items-center gap-2">
              ...
              />
              <span className="w-32 shrink-0 truncate font-semibold">{c.title}</span>
              ...
              <span className="ml-auto flex flex-wrap gap-2 [&>button]:shrink-0 [&>button]:whitespace-nowrap">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-brand-200 px-5 py-2.5 text-sm font-semibold text-brand-600 hover:bg-brand-50"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth={3.5} strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4" aria-hidden="true">
                    <path d="M9 7.6v8.8l7-4.4z" />
                  </svg>
                  테스트 플레이
                </button>
                <button
